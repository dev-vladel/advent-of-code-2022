...
# where the four most recently received characters were all different. Specifically, it needs to report the number of characters from the beginning of the
...
def main():
    ...
    first_message_marker_position = find_marker_position(
        contents, FIRST_MESSAGE_POSITION
    )
