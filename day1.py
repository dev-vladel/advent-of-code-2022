...
elvesCalories = file.read().strip().split('\n\n')
calories = []

for elfCalories in elvesCalories:
    elfTotal = elfCalories.split('\n')
    elfTotal = [eval(i) for i in elfTotal]
    calories.append(sum(elfTotal))

answer1 = max(calories)
print('The answer for 1st part is:', answer1)
...
print('The answer for 2nd part is:', answer2)
